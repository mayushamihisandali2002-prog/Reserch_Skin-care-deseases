...
print("\n3. Saving models...")
try:
    with open('assets/models/text_model.pkl', 'wb') as f:
...
try:
    with open('assets/models/vectorizer.pkl', 'wb') as f:
...
print("Model files location: assets/models/text_model.pkl, assets/models/vectorizer.pkl")
