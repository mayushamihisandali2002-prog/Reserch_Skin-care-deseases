...
DATA_DIR = BACKEND_DIR / "assets" / "data" / "conversational_diagnosis_assistant"
MODELS_DIR = BACKEND_DIR / "assets" / "models" / "conversational_diagnosis_assistant"
...
def retrain_fallback_model():
    ...
    data_path = DATA_DIR / "disease_symptom_edges_expanded.csv"
