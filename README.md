...
Input Skin Image ↓ CNN Feature Extractor ↓ Domain-Invariant Feature Space ├── Disease Classifier └── Domain Discriminator (Adversarial Training) ↓ Subtype-Aware Fair Classification
...
✔ Supervisor-safe
✔ Viva-safe
✔ GitHub-professional# Reserch_Skin-care-deseases
